...
|---|---|---|
| `square-progressions/seven-consecutive-squareclasses` | internally accepted | Seven consecutive nonzero rational terms whose affine squareclass rank is at most two are reduced through the exact chain `651 -> 343 -> 284 -> 98 -> 54 -> 35 -> 23`.  Realizability or impossibility of the final 23 patterns, and therefore `R_2(7)`, remain open. |
