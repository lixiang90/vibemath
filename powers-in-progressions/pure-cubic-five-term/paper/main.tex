...
prove that one positive-rank genus-one curve supplies infinite families in
four distinct four-hit orbits.  Besides $((0,1,3,4),0001)$ and
$((0,1,2,3),0010)$, these are $((0,1,2,3),0100)$ and
$((0,1,2,4),0111)$.  Explicit first members are displayed below.
\end{abstract}
...
\emph{five-hit color/position class}.  The next section settles four of the 31
four-hit models left by the orbit sieve; it does not classify every rational
progression attaining four hits.  The other 27 models remain distinct
...
\section{Four four-hit branches on a positive-rank cubic}

We now strengthen Theorem~\ref{thm:main} in exactly four of the 31
...
in the four stated four-hit orbits.  We make no priority claim and no
classification claim for the other 27 four-hit models.  The supplement also
