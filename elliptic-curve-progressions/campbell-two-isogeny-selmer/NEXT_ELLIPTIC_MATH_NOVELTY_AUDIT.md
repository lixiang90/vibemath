...
passes **56/56 tests**.  No Magma, Sage, PARI/GP, remote CAS, or claimed
...
## 7. Round-09 artifact and claim boundary
...
of the 56-test command above.  The current paper is 10 pages.  Its SHA-256 is
