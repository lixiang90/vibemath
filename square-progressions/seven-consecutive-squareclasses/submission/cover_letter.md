...
> **Venue-policy gate (verified 2026-09-03).** This template is for a
> human-approved eligible venue; the current first choice is Research in Number
> Theory.  Do not use it to submit to INTEGERS: that journal's
> [official instructions](https://math.colgate.edu/~integers/submit.html)
> exclude articles for which AI produced mathematics, computer code,
> bibliographic information, or other content, and this project materially used
> AI assistance in those categories.  Recheck the chosen venue's current policy
> before submission.
