...
`paper-square-supplement-v0.6.0`.  Its root file is
`PAPER_SQUARE_SUPPLEMENT_MANIFEST.json`, SHA-256
`3ad3dd167ad349ad6d0720e558e96c6546797ffcfa26788827be512001b41659`.
The manifest lists 26 bound artifacts, their byte lengths and SHA-256 values,
...
version and do not reuse the v0.6.0 supplement hash.
