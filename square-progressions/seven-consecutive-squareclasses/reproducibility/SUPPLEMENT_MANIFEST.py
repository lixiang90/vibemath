...
RELEASE_ID = "paper-square-supplement-v0.5.0"
...
def build_manifest() -> dict[str, object]:
    ...
    return {
        ...
        "reproduction_commands": [
            ...
            "python -m unittest -v STUDENT_SQUARE_ROUND_02_test_patterns.py STUDENT_SQUARE_ROUND_03_test.py STUDENT_SQUARE_ROUND_04_test.py PAPER_SQUARE_SAFE_test.py PAPER_SQUARE_MASK77_test.py PAPER_SQUARE_NEXT_GATE_test.py PAPER_SQUARE_MASK108_test.py PAPER_SQUARE_SUPPLEMENT_MANIFEST_test.py",
        ],
        "claim_boundary": {
            "proved": "exact finite pattern counts and the mask 77, 89, 102, 108 exclusions documented in the paper",
            "not_proved": "realizability or impossibility of the 23 remaining patterns; R_2(7) is not decided",
        },
    }
