...
RELEASE_ID = "paper-square-supplement-v0.6.0"
...
def build_manifest() -> dict[str, object]:
    ...
    return {
        ...
        "claim_boundary": {
            "proved": "exact finite pattern counts and the mask 77, 89, 102, 108, 99 exclusions documented in the paper",
            "not_proved": "realizability or impossibility of the 15 remaining patterns; R_2(7) is not decided",
        },
    }
