...
masks 77/89, 102, 108, 99, 51, and 90.  The code and JSON certificates expose every finite
branch used in those reductions.

## Not proved

The seven remaining necessary patterns are not classified as realizable or
